...
extern "C"
JNIEXPORT jobject JNICALL
Java_com_android_tv_settings_library_about_VulkanUtils_getVkInfo(
    ...
    // });
    jclass vkPhysicalDevicesClass = withJniCheck<jclass>(env, [=]() {
        return env->FindClass("com/android/tv/settings/library/about/VulkanUtils$VkPhysicalDevices");
    });
